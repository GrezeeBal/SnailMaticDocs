...
В этом репозитории нахордится сборник переменных от разработчиков биндера, которые не попали в стандартный набор. Сборник время от времени пополняется новыми переменными.
