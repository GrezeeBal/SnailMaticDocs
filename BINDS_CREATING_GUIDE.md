...
```
> Опять же, усли бинды находятся не в первой папке, а в любой другой - нужно будет еще дописать название папки /sm.select [номер бинда/имя бинда]* [папка]
