...
В параметр с помощью вышеупомянутых функ. переменных вставляются математические выражения и `@math` просто их считает, возвращая результат. Пример с `@paramcmd` смотри выше.
