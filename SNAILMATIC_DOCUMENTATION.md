...
| /sm.bindstart  | Запустить бинд через команду.  |
| /sm.bindstop  | Остановить запущенный бинд через команду. Если не вводить никакие параметры - остановятся все запущенные бинды  |
