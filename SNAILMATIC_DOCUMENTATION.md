...
Минус этих версий в том, что при обновлении биндера они будут перекачиваться на основную версию, и тебе прийдется заново перекачивать этот фикс (все настройки и профили сохранятся)
