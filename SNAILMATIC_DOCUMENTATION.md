...
`Решение`: Ошибка возникает из-за старой видеокарты, которая не в состоянии обработать большой атлас шрифтов. Создай текстовый документ **_512_2048.txt_** или **_512_1024.txt_** в папке _\Документы\GTA San Andreas User Files\SAMP\SnailMatic_
