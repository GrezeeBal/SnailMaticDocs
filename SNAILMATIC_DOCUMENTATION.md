...
> Режим биндера, который полностью полагается на функции SAMFUNCS (самый стабильный режим из всех, но в твоей сборке должен быть установлен сампфункс). С этим режимом биндер не будет работать на версиия сампа R4-2
