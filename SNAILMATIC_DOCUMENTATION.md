...
<b>#font12</b> — устанавливает для текста в одной строке размер шрифта (12, 14, 16, 18, 30)
...
`Решение`: Это происходит из-за того, что на строках не установлена задержка. Если между строками нет задержки - они отправляются моментально, что превращается во флуд - сервер в свою очередь флуд будет блокировать.
